...
public class OxygenFactory {
	...
	public String toString() {
		return name + " ,position =" + getPosition() + ", max_water_volume=" + max_water_volume
				+ ", current_water_volume=" + current_water_volume + ", max_oxygen_volume=" + max_oxygen_volume
				+ ", current_oxygen_volume=" + current_oxygen_volume + ", max_raw_material_volume="
				+ max_raw_material_volume + ", current_raw_material_volume=" + current_raw_material_volume
				+ ", energy_comsumption=" + energy_comsumption + ", oxygen_production=" + oxygen_production
				+ ", factory_area=" + factory_area + ", factory_volume=" + factory_volume + ", temperature="
