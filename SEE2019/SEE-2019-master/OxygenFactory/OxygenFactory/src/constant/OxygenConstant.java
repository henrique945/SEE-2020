...
public final class OxygenConstant {
	...
	public static final Position OXYGEN_FACTORY = new Position(-817331.939286128, -29535.93633636, -1510979.25); /// Oxygen
																													/// Factory
	public static final Double LOWEST_HEIGHT = Double.parseDouble(mapa.get("LOWEST_HEIGHT"));																												/// Position
	...
	public static final Double CURRENT_RAW_MATERIAL_VOLUME = Double
			.parseDouble(mapa.get("CURRENT_RAW_MATERIAL_VOLUME"));
	...
	public static final Double ENERGY_CONSUMPTION_PER_MINUTE = Double
			.parseDouble(mapa.get("ENERGY_CONSUMPTION_PER_MINUTE"));
