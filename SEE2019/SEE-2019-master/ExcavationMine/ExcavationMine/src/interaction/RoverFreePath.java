...
@InteractionClass(name = "RoverFreePath")
public class RoverFreePath {
	...
	public RoverFreePath(){
		roverId = "";
		path = new PositionCollection(new ArrayList<>());
	}
	
	public RoverFreePath(PositionCollection collection,String roverId){
	...
	public String toString() {
		return "RoverFreePath [path=" + path + ", roverId=" + roverId + "]";
	}
