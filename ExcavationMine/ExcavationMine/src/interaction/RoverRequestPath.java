...
@InteractionClass(name = "RoverRequestPath")
public class RoverRequestPath{
	...
	public RoverRequestPath(){
		roverID = "";
		currentPosition = new Position(0, 0, 0);
		targetPosition = "";
	}
	
	public RoverRequestPath(Position currentPosition, String targetPosition, String roverID){
	...
	public String toString() {
		return "RoverRequestPath [roverID=" + roverID + ", currentPosition=" + currentPosition + ", targetPosition="
				+ targetPosition + "]";
	}
