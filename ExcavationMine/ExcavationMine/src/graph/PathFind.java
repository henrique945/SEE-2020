...
public class PathFind {
	...
	public ArrayList<Position> GetIn(Point from, Point to, String key) throws InterruptedException {
		ArrayList<Position> new_positions;
		try {
	...
	public Point convertPoint(Position position) {
		int x = (int) (PositionOfMine.getPosition("east").x + position.getX() - PositionOfMine.referenceRover.getX());

		int y = (int) (PositionOfMine.getPosition("east").y - position.getY() + PositionOfMine.referenceRover.getY());

		return new Point(x, y);
	}// Method that converts position to point

	public Position convertPosition(Point point) {
		double x = PositionOfMine.referenceRover.getX() - PositionOfMine.getPosition("east").x + point.x;
		double y = PositionOfMine.referenceRover.getY() + PositionOfMine.getPosition("east").y - point.y;
		double z = PositionOfMine.referenceRover.getZ();
