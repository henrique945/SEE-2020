...
public class SpaceTimeCoordinateStateCoder implements Coder<SpaceTimeCoordinateState> {
	...
	public SpaceTimeCoordinateState decode(byte[] arg0) throws DecoderException {
		...
		rotState.setAttitudeQuaternion(new Quaternion(decodeVector[0],new double[]{decodeVector[1],decodeVector[2],decodeScalar}));//decodeScalar, decodeVector));
	...
	public byte[] encode(SpaceTimeCoordinateState arg0) {
		...
		// ************** Rotational State *********************
		this.scalar.setValue(arg0.getRotationState().getAttitudeQuaternion().getQ3());
		this.vector.get(0).setValue(arg0.getRotationState().getAttitudeQuaternion().getQ0());
		this.vector.get(1).setValue(arg0.getRotationState().getAttitudeQuaternion().getQ1());
		this.vector.get(2).setValue(arg0.getRotationState().getAttitudeQuaternion().getQ2());
