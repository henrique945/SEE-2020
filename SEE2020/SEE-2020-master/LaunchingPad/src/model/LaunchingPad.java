...
@ObjectClass(name = "PhysicalEntity.FACENS_Launching_Pad")
public class LaunchingPad {
	...
	public LaunchingPad(String name, String parent_name, String type, Double power_supply,
			Double power_consumption, Double battery_level, Position position) {
		super();
		this.name = name;
	...
	public String toString() {
		return "LaunchingPad [name=" + name + ", parent_name=" + parent_name + ", state=" + state + ", type=" + type
				+ ", power_supply=" + power_supply + ", power_consumption=" + power_consumption + ", battery_level="
				+ battery_level + ", Position=" + getPosition() + "]";
	}
