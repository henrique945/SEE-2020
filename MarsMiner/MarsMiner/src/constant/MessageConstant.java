...
public final class MessageConstant {
	...
	/**
	 * Source: ExcavationMine
	 * Destination: MarsMiner
	 */
	...
	/**
	 * Destination: Oxygen Factory
	 */
	public static final String REQUEST_OXYGEN_FACTORY_FULL = "request-oxygen-factory-full";
	public static final String REQUEST_OXYGEN_FACTORY_OK = "request-oxygen-factory-ok";
