...
public class OxygenFactory {
	...
	public OxygenFactory(String name, String parent_name, String type,
			Double max_water_volume, Double current_water_volume, Double max_oxygen_volume,
			Double current_oxygen_volume, Double max_raw_material_volume, Double current_raw_material_volume,
			Double energy_comsumption, Double oxygen_production, Double factory_area, Double factory_volume,
			Double temperature, Double pressure, Position position) {
		super();
		this.name = name;
